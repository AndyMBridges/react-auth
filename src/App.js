...
class App extends Component {
    ...
    static defaultProps = {
        clientId: 'rPkIs5gUgatXHawjiAmZkrJO43Ozp5Au',
        domain: 'andythinkjam.eu.auth0.com'
    }
    ...
    // Clear state and local storage to logout
    logout(){
        this.setState({
            idToken: '',
            profile: ''
    ...
    render() {
        ...
        if(this.state.idToken) {
            page = <Dashboard profile={this.state.profile}/>
        } else {
            page = <Home />
        }
        return (
